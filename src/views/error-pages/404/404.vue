<template>
  <div class="page-404-container">
    <div class="page-404">
      ...
      <div class="bullshit">
        <p class="bullshit__oops">OOPS!</p>
        <p class="bullshit__info">All rights reserved
          <a style="color: #20a0ff" href="https://github.com/JackieCheung/vue-element-template" target="_blank">
            Vue Element Template
          </a>
        </p>
        <p class="bullshit__headline">{{ message }}</p>
        <p class="bullshit__info">
